		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Leaflet Map (Train)",
									"targetURL": "#comjecleafletmap-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comjecleafletmap-display": {
								"semanticObject": "comjecleafletmap",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.jec.leafletmap",
									"url": sap.ui.require.toUrl("com/jec/leafletmap")
								}
							}
						}
					}
